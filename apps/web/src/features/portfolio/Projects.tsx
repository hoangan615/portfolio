...
const PROJECTS: ProjectData[] = [
  {
    ...
    tagline: 'Enterprise AI Document Processing Platform',
    description:
      'Built an AI-powered document intelligence platform integrating OCR and LLMs to automate classification, extraction, and validation — cutting manual data entry by 80% and achieving 98% OCR accuracy on production data.',
    impacts: [
      { value: '−80%', label: 'Manual data entry' },
